...
export interface CoaTerm {
  ...
  fullName: string;  // 英文全称 + 中文全称，如 "Read-Only Memory（只读存储器）"
  definition: string;
  keywords: string[];
  tips?: string;
  important?: boolean;
...
export const coaTerms: CoaTerm[] = [
  {
    id: 'coa-1',
    term: 'ROM',
    fullName: 'Read-Only Memory（只读存储器）',
  ...
  },
  {
    id: 'coa-3',
    term: 'DRAM',
    fullName: 'Dynamic Random-Access Memory（动态随机存取存储器）',
  ...
  },
  {
    id: 'coa-4',
    term: 'RISC',
    fullName: 'Reduced Instruction Set Computer（精简指令集计算机）',
  ...
  },
  {
    id: 'coa-5',
    term: 'EEPROM',
    fullName: 'Electrically Erasable Programmable Read-Only Memory（电可擦除可编程只读存储器）',
  ...
  },
  {
    id: 'coa-6',
    term: 'HLDA',
    fullName: 'Hold Acknowledge（总线响应信号）',
  ...
  },
  {
    id: 'coa-7',
    term: 'MDR',
    fullName: 'Memory Data Register（存储器数据寄存器）',
  ...
  },
  {
    id: 'coa-8',
    term: 'INTA',
    fullName: 'Interrupt Acknowledge（中断响应信号）',
  ...
  },
  {
    id: 'coa-9',
    term: 'PC',
    fullName: 'Program Counter（程序计数器）',
  ...
  },
  {
    id: 'coa-10',
    term: 'EPROM',
    fullName: 'Erasable Programmable Read-Only Memory（可编程只读存储器）',
  ...
  },
  {
    id: 'coa-11',
    term: 'MAR',
    fullName: 'Memory Address Register（存储器地址寄存器）',
  ...
  },
  {
    id: 'coa-12',
    term: 'DMA',
    fullName: 'Direct Memory Access（直接内存访问）',
  ...
  },
  {
    id: 'coa-13',
    term: 'RAM',
    fullName: 'Random-Access Memory（随机存取存储器）',
  ...
  },
  {
    id: 'coa-14',
    term: 'PROM',
    fullName: 'Programmable Read-Only Memory（一次性编程只读存储器）',
  ...
  },
  {
    id: 'coa-15',
    term: 'ALU',
    fullName: 'Arithmetic Logic Unit（算术逻辑单元）',
  ...
  },
  {
    id: 'coa-16',
    term: 'IR',
    fullName: 'Instruction Register（指令寄存器）',
  ...
  },
  {
    id: 'coa-17',
    term: 'SRAM',
    fullName: 'Static Random-Access Memory（静态随机存取存储器）',
  ...
  },
  {
    id: 'coa-18',
    term: 'CISC',
    fullName: 'Complex Instruction Set Computer（复杂指令集计算机）',
  ...
  },
  {
    id: 'coa-19',
    term: 'MREQ',
    fullName: 'Memory Request（访存控制信号）',
  ...
  },
  {
    id: 'coa-20',
    term: 'FLOPS',
    fullName: 'Floating Point Operations Per Second（每秒浮点运算次数）',
