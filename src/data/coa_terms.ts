...
export interface CoaTerm {
  ...
  fullName: string;  // 英文全称，如 "Read-Only Memory"
  definition: string;
  keywords: string[];
  tips?: string;
  important?: boolean;
...
export const coaTerms: CoaTerm[] = [
  ...
  },
  {
    id: 'coa-4',
    term: 'RISC',
    fullName: 'Reduced Instruction Set Computer',
  ...
  },
  {
    id: 'coa-5',
    term: 'EEPROM',
    fullName: 'Electrically Erasable Programmable Read-Only Memory',
  ...
  },
  {
    id: 'coa-8',
    term: 'INTA',
    fullName: 'Interrupt Acknowledge',
  ...
  },
  {
    id: 'coa-14',
    term: 'PROM',
    fullName: 'Programmable Read-Only Memory',
  ...
  },
  {
    id: 'coa-18',
    term: 'CISC',
    fullName: 'Complex Instruction Set Computer',
  ...
  },
  {
    id: 'coa-20',
    term: 'FLOPS',
    fullName: 'Floating Point Operations Per Second',
