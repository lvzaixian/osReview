...
import LinuxCommandCards from './components/LinuxCommandCards';
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16 relative z-10">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
          ...
          >
            ...
            <div className="text-2xl font-black tracking-tight">🎯 Linux核心考点</div>
            <div className="text-sm opacity-95 font-medium text-center">
              基于重点.md提炼的必考知识
            </div>
          </button>
          ...
          >
            ...
            <div className="text-2xl font-black tracking-tight">💻 Linux命令记忆卡</div>
            <div className="text-sm opacity-95 font-medium text-center">
              全景选项库 · 场景化记忆
            </div>
          </button>
        ...
        <div className="max-w-4xl mx-auto mb-7">
          ...
          >
            ...
            <div className="text-base sm:text-lg opacity-95 font-semibold">
              选择 · 填空 · 判断 · 简答 · 代码解析 · Shell编程 · 全类型覆盖
            </div>
          </button>
        </div>
